...
<head>
    ...
    <body >
        <table style="width:960px;min-width:960px;margin:0 auto;">
            <tr>
                <td style="width:960px;min-width:960px;">
				<div style="display:block;width:960px;font-weight:100;font-size:20px;text-align:right;float: left;border-top:1px solid #ddd;margin-top:10px;padding-top:30px;">
                                <p style="font-family:sans-serif;font-size:13px;font-weight:100;text-align:left">
                                    Caro(a) cliente,
									</p>
                                <p style="font-family:sans-serif;font-size:13px;font-weight:100;text-align:left">
								...
								<p style="font-family:sans-serif;font-size:13px;font-weight:100;text-align:left">
									Deverá guardar este email até receber os produtos encomendados.
								</p>
								<p style="font-family:sans-serif;font-size:13px;font-weight:100;text-align:left">
									Informamos que este email, não serve como fatura, sendo esta enviada à parte.
								</p>
								<p style="font-family:sans-serif;font-size:13px;font-weight:100;text-align:left">
									Por favor envie o comprovativo de pagamento para o e-mail geral@healthydiet.pt
                                </p>
                            </div>
                            <div style="display:block;float:left;width:100%;font-weight:100;font-size:20px;">
                                ...
                                <div style="display:block;font-weight:100;font-size:20px;text-align:left;float:left;width:50%">
                                    ...
                                    <p style="width:50%;text-align: left;display: inline-block;margin: 0px 0px 10px 10px;font-size: 13px;"><?php echo date("d-m-Y");  ?></p>
                                    <p style="width:45%;text-align: right;display: inline-block; margin: 0px;font-size: 13px;" >Nº de Utilizador:</p>
                                    <p style="width:50%;text-align: left;display: inline-block;margin: 0px 0px 10px 10px;font-size: 13px;"><?php echo $data_user['user']->id; ?></p>
                                    <p style="width:45%;text-align: right;display: inline-block; margin: 0px;font-size: 13px;" >Faturado a:</p>
                                    <p style="width:50%;text-align: left;display: inline-block;margin: 0px 0px 10px 10px;font-size: 13px;"><?php echo $data_order['order']->name; ?></p>
                                    <p style="width:45%;text-align: right;display: inline-block; margin: 0px;font-size: 13px;" >Nº de Contribuinte:</p>
                                    <p style="width:50%;text-align: left;display: inline-block;margin: 0px 0px 10px 10px;font-size: 13px;"> <?php echo $data_user['user']->nif; ?></p>
                                    <p style="width:45%;text-align: right;display: inline-block; margin: 0px;font-size: 13px;" >Nº de Encomenda:</p>
                                    <p style="width:50%;text-align: left;display: inline-block;margin: 0px 0px 10px 10px;font-size: 13px;"><?php echo $data_order['order']->id; ?></p>
                            ...
                            <div style="display:block;float:left;width:100%;font-weight:100;font-size:20px;">
                                <div style="display:block;text-align:left;float:left;width:40%;position:relative;background:#F8F7F6;padding: 3.5%;margin-top: 20px;margin-bottom: 20px;margin-right: 3%;">
                                    ...
                                    <p style="font-family:sans-serif;line-height:15px;font-weight:100;font-size:13px">
                                        <?php echo $data_user['eaddress']->zipNumber;?>
                                    </p>
                                    <p style="font-family:sans-serif;line-height:15px;font-weight:100;font-size:13px">
                                ...
                                <div style="display:block;width:40%;font-weight:100;font-size:20px;text-align:left;float:left;position:relative;background:#F8F7F6;padding: 3.5%;margin-top: 20px;margin-bottom: 20px;margin-left: 3%" >
                                    ...
                                    <p style="font-family:sans-serif;line-height:15px;font-weight:100;font-size:13px">
                                        <?php echo $data_user['faddress']->zipNumber;  ?>
                                    </p>
                                    <p style="font-family:sans-serif;line-height:15px;font-weight:100;font-size:13px">
